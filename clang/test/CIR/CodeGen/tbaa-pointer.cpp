...
int test_scalar_pointer(int*** p3) {
    ...
    // CIR-POINTER-TBAA: %{{.*}} = cir.load {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!cir.ptr<!cir.ptr<!s32i>>>>, !cir.ptr<!cir.ptr<!cir.ptr<!s32i>>> tbaa(#tbaa[[p3_INT]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load deref {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!cir.ptr<!s32i>>>, !cir.ptr<!cir.ptr<!s32i>> tbaa(#tbaa[[p2_INT]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!cir.ptr<!s32i>>>, !cir.ptr<!cir.ptr<!s32i>> tbaa(#tbaa[[p2_INT]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load deref {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!s32i>>, !cir.ptr<!s32i> tbaa(#tbaa[[p1_INT]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!s32i>>, !cir.ptr<!s32i> tbaa(#tbaa[[p1_INT]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load deref {{.*}} %{{.*}} : !cir.ptr<!s32i>, !s32i {{.*}}
...
int test_struct_pointer(A*** p3, int A::***m3) {
    ...
    // CIR-POINTER-TBAA: %{{.*}} = cir.load {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!cir.ptr<!cir.ptr<!rec_A>>>>, !cir.ptr<!cir.ptr<!cir.ptr<!rec_A>>> tbaa(#tbaa[[p3_STRUCT_A]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load deref {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!cir.ptr<!rec_A>>>, !cir.ptr<!cir.ptr<!rec_A>> tbaa(#tbaa[[p2_STRUCT_A]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!cir.ptr<!rec_A>>>, !cir.ptr<!cir.ptr<!rec_A>> tbaa(#tbaa[[p2_STRUCT_A]])
    // CIR-POINTER-TBAA: %{{.*}} = cir.load deref {{.*}} %{{.*}} : !cir.ptr<!cir.ptr<!rec_A>>, !cir.ptr<!rec_A> tbaa(#tbaa[[p1_STRUCT_A]])
