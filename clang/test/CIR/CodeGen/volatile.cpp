...
// CHECK: cir.func dso_local @_Z10test_storePVi
...
// CHECK: cir.func dso_local @_Z16test_load_field1PV3Foo
...
// CHECK: cir.func dso_local @_Z16test_load_field2P3Foo
// CHECK:   %[[MemberAddr:.+]] = cir.get_member
// CHECK:   %{{.+}} = cir.load volatile{{.*}} %[[MemberAddr]]
...
// CHECK: cir.func dso_local @_Z16test_load_field3P3Foo
// CHECK:   %[[MemberAddr:.+]] = cir.get_member
...
// CHECK: cir.func dso_local @_Z17test_store_field1PV3Foo
// CHECK:   %[[MemberAddr:.+]] = cir.get_member
...
// CHECK: cir.func dso_local @_Z17test_store_field2P3Foo
// CHECK:   %[[MemberAddr:.+]] = cir.get_member
// CHECK:   cir.store volatile{{.*}} %{{.+}}, %[[MemberAddr]]
...
// CHECK: cir.func dso_local @_Z17test_store_field3P3Foo
// CHECK:   %[[MemberAddr:.+]] = cir.get_member
